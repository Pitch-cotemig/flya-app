      ...
      <Content>
        <Header>
          ...
          <Subtitle>
            ...
            acessar ou usar a Flya, você concorda em cumprir estes termos.
          </Subtitle>
        </Header>
        ...
        <Section>
          ...
          <p>
            Ao acessar e usar a plataforma Flya, você aceita e concorda em
            cumprir estes Termos de Uso. Se você não concordar com qualquer
            parte destes termos, não deve usar nossos serviços.
          </p>
          <p>
            Estes termos constituem um acordo legal entre você e a Flya.
            Recomendamos que você leia cuidadosamente todos os termos antes de
        ...
        <Section>
          ...
          <p>A Flya é uma plataforma de planejamento de viagens que oferece:</p>
          <ul>
        ...
        <Section>
          ...
          <p>
            Você deve ter pelo menos 13 anos para usar nossos serviços. Usuários
            menores de 18 anos devem ter consentimento parental.
          </p>
        </Section>
        ...
        <Section>
          ...
          <p>
            Você concorda em usar nossos serviços apenas para propósitos legais
        ...
        <Section>
          ...
          <p>
            Você é responsável por todo o conteúdo que compartilha. Não
            compartilhe conteúdo que seja ilegal, ofensivo ou viole direitos de
            terceiros.
          </p>
        </Section>
        ...
        <Section>
          ...
          <p>
            Sua privacidade é importante para nós. O uso de suas informações
            pessoais é regido por nossa Política de Privacidade, que faz parte
            destes termos.
          </p>
          <p>
            Coletamos e processamos dados pessoais conforme necessário para
            fornecer nossos serviços, sempre em conformidade com a LGPD e outras
            leis aplicáveis.
          </p>
        </Section>
        ...
        <Section>
          ...
          <p>
            A Flya e todo o conteúdo da plataforma (incluindo, mas não se
            limitando a, textos, gráficos, logos, ícones, imagens, clipes de
            áudio, downloads digitais e compilações de dados) são propriedade da
            Flya ou de seus licenciadores.
          </p>
          <p>
            É proibido copiar, reproduzir, distribuir, transmitir, exibir,
            vender, licenciar ou explorar comercialmente qualquer parte do
        ...
        <Section>
          ...
          <p>
            ...
            Não garantimos que os serviços serão ininterruptos ou livres de
            erros.
          </p>
          <p>
            Em nenhuma circunstância a Flya será responsável por danos
            indiretos, incidentais, especiais, consequenciais ou punitivos,
            incluindo perda de lucros, dados ou uso.
          </p>
        </Section>
        ...
        <Section>
          ...
          <p>
            ...
            momento. Mudanças significativas serão comunicadas através da
        ...
        <Section>
          ...
          <p>
            ...
            qualquer motivo, incluindo violação destes termos.
          </p>
          <p>
        ...
        <Section>
          ...
          <p>
            ...
            será resolvida nos tribunais da comarca de Belo Horizonte, MG.
          </p>
        </Section>
